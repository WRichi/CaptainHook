...
import at.hagenberg.captainhook.model.spotify.spotify_model.Image;
import at.hagenberg.captainhook.model.spotify.spotify_model.Playlists;
                ...
                spotifyViewModel.searchSpotify(search_text, searchType, new SpotifySearchResultCallback() {
                    ...
                    public void onSearchResult(final SpotifyData spotifyData) {
                        ...
                        if (spotifyData.getPlaylists() == null) {
                            ...
                            List<at.hagenberg.captainhook.model.spotify.spotify_model.playlist.Item> items = playlists.getItems();
                            for (int x = 0; x < items.size(); x++) {
                                at.hagenberg.captainhook.model.spotify.spotify_model.playlist.Item item = items.get(x);
                                    ...
                                    if (currentResult == SpotifySearchType.TRACK) {
                                        ...
                                        spotifyViewModel.getTracksForUrl(spotifySearchModel.getTracksURL(), new SpotifyGetTracksFromPlaylistCallback() {
                                            ...
                                            public void onTrackResult(Tracks tracks) {
                                                ...
                                                List<at.hagenberg.captainhook.model.spotify.spotify_model.tracksinplaylist.Item> trackList = tracks.getItems();
                                                for (int i = 0; i < trackList.size(); i++) {
                                                    at.hagenberg.captainhook.model.spotify.spotify_model.tracksinplaylist.Item item = trackList.get(i);
                                                    String artist = "";
